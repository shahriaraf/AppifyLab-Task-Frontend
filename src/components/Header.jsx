...
const Header = ({ user }) => {
  ...
  const handleLogout = () => {
    logout(); // Clears state and localStorage via Context
    navigate("/login");
  };
      ...
      <div className="container _custom_container">
        ...
        <div className="collapse navbar-collapse" id="navbarSupportedContent">
          ...
          <div className="_header_nav_profile">
            ...
            {/* PROFILE DROPDOWN (Exact HTML Structure) */}
            <div id="_prfoile_drop" className={`_nav_profile_dropdown _profile_dropdown ${showProfile ? 'show' : ''}`}>
                <div className="_nav_profile_dropdown_info">
                    <div className="_nav_profile_dropdown_image">
                        <img src={user?.profilePic || "/assets/images/profile.png"} alt="Image" className="_nav_drop_img"/>
                    </div>
                ...
                <ul className="_nav_dropdown_list">
                    ...
                    <li className="_nav_dropdown_list_item">
                        <a href="#0" className="_nav_dropdown_link">
                            ...
                            <button type="button" class="_nav_drop_btn_link">
