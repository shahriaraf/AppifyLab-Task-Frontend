    ...
    <div className="_feed_inner_text_area _b_radious6 _padd_b24 _padd_t24 _padd_r24 _padd_l24 _mar_b16">
        <div className="_feed_inner_text_area_box">
            ...
            <div className="form-floating _feed_inner_text_area_box_form">
                ...
                <label className="_feed_textarea_label">Write something ... <svg xmlns="http://www.w3.org/2000/svg" width="22" height="22" fill="none" viewBox="0 0 23 24">
        ...
        <div className="_feed_inner_text_area_bottom">
            ...
            <div className="_feed_inner_text_area_btn">
                <button type="button" onClick={handleSubmit} className="_feed_inner_text_area_btn_link"><svg class="_mar_img" xmlns="http://www.w3.org/2000/svg" width="14" height="13" fill="none" viewBox="0 0 14 13">
